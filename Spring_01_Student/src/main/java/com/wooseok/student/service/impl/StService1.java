 ...
 * StDao, StDaoImpl, StService 는 상당히 끈끈한 관계가 이루어진다
 * 결합이 발생했다
 *
...
public class StService1 implements StService {
    ...
    // private final StDaoImpl stDao1 = new StDaoImpl(); // 1번 코드
    private final StDao stDao2 = new StDaoImpl(); // 2번 코드

    @Override
    public List<StudentVO> selectAll() {
        // List<StudentVO> stList1 = stDao1.findAll();

        List<StudentVO> stList2 = stDao2.selectAll();
        // stList2 = stDao2.findAll();  ( X )
