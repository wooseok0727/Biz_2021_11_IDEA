...
@ComponentScan(basePackages = {
        "com.wooseok.java.controller",
        "com.wooseok.java.service",
        "com.wooseok.java.config.beans"
        })
public class ServletConfig implements WebMvcConfigurer {
    ...
    /**
     * method 에 @Bean Annotation 을 부착하면 이 method는 반드시 객체를 생성해서 return 해야 한다.
     * InternalResourceViewResolver 를 생성해서 값을 return 했음.
     * Spring 컨테이너는 프로젝트가 시작되는 시점에 이 method 를 자동으로(강제로) 실행하고 생성된 객체를 컨테이너에 보관하여
