...
import com.wooseok.security.config.Message;
...
public class LoginFailService implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
        ...
        if (exceptionClassName.equalsIgnoreCase("credentialExpiredException")) {
        ...
        if(exception instanceof CredentialsExpiredException) {
            error_msg = Message.ERROR.CredentialExpired;
        ...
        request.setAttribute("AUTHOR","crash2@naver.com");
